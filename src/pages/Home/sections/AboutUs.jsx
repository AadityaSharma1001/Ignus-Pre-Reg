    ...
    <section className="relative w-full py-8 flex justify-center overflow-hidden min-h-[700px]">
      ...
      <style>
        {`
          ...
          .cloud-2 { top: 72%; animation: driftCloud 100s linear infinite; animation-delay: -40s; }
          ...
          .cloud-3 .puff:nth-child(1) { width: 180px; height: 110px; left: 0; top: 70px; }
          .cloud-3 .puff:nth-child(2) { width: 200px; height: 130px; left: 100px; top: 40px; }
          .cloud-3 .puff:nth-child(3) { width: 230px; height: 150px; left: 240px; top: 10px; }
          .cloud-3 .puff:nth-child(4) { width: 210px; height: 140px; left: 400px; top: 0px; }
          .cloud-3 .puff:nth-child(5) { width: 180px; height: 120px; left: 540px; top: 25px; }
          .cloud-3 .puff:nth-child(6) { width: 160px; height: 100px; left: 140px; top: 100px; }
          .cloud-3 .puff:nth-child(7) { width: 190px; height: 120px; left: 320px; top: 85px; }
          
          /* Cloud 4 - Small mid-left */
          .cloud-4 { top: 65%; animation: driftCloud 110s linear infinite; animation-delay: -20s; }
          .cloud-4 .puff:nth-child(1) { width: 120px; height: 75px; left: 0; top: 50px; }
          .cloud-4 .puff:nth-child(2) { width: 140px; height: 90px; left: 70px; top: 30px; }
          .cloud-4 .puff:nth-child(3) { width: 160px; height: 100px; left: 160px; top: 10px; }
          ...
          .cloud-4 .puff:nth-child(6) { width: 130px; height: 80px; left: 100px; top: 70px; }
          
          /* Cloud 5 - Small bottom right accent */
          .cloud-5 { top: 85%; animation: driftCloud 85s linear infinite; animation-delay: -55s; }
          .cloud-5 .puff:nth-child(1) { width: 150px; height: 95px; left: 0; top: 60px; }
          .cloud-5 .puff:nth-child(2) { width: 170px; height: 110px; left: 90px; top: 35px; }
          .cloud-5 .puff:nth-child(3) { width: 190px; height: 125px; left: 200px; top: 10px; }
          .cloud-5 .puff:nth-child(4) { width: 170px; height: 110px; left: 340px; top: 0px; }
          .cloud-5 .puff:nth-child(5) { width: 150px; height: 95px; left: 460px; top: 20px; }
          .cloud-5 .puff:nth-child(6) { width: 160px; height: 100px; left: 120px; top: 80px; }
          .cloud-5 .puff:nth-child(7) { width: 140px; height: 90px; left: 280px; top: 70px; }
